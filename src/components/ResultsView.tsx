...
${result.performanceMessage}`;
  ...
  return (
    <div
      ...
      className="w-full max-w-4xl mx-auto my-6 bg-[#171411] border border-[#2c241c] rounded-2xl p-6 sm:p-8 shadow-2xl shadow-[#ff6b00]/5 animate-in fade-in zoom-in-95 duration-200"
    >
